...
using TelemetryServer.Exporters.f122;
using TelemetryServer.Utilities;

namespace TelemetryServer.Processor.f122
{
    public class PacketProcessorF12022 : GameProcessor
    {
        ...
        public void Process(IPEndPoint sender, byte[] data)
        {
            ...
            {
                Console.WriteLine($"Pacote do F1 2022 de {sender.Address} é muito pequeno.");
                return;
            }
