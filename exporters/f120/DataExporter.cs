...
namespace TelemetryServer.Exporters.f120
{
    public class DataExporter
    {
        ...
        public string exportConfigurationBasicData(string identifier)
        {
            return $"[{identifier}]" +
                   ...
                   $"\n__bestLapTime=__bestLapTime,3" +
                   $"\n__bestLapNum=__bestLapNum,4" +
        ...
        public string exportConfigurationDetailsData(int carIndex)
        {
            ...
            return $"{this._lapData.AllLapData[carIndex].LapDistance}" +
                   ...
                   $";{this._lapData.AllLapData[carIndex].BestLapTime}" +
                   $";{this._lapData.AllLapData[carIndex].BestLapNum}" +
