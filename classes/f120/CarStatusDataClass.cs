...
namespace TelemetryServer.Classes.f120
{
    public class PacketCarStatusDataClass : HeaderClass
    {
        ...
        public class CarStatusDataClass
        {
            ...
            public byte[] TyresWear { get; private set; }
            ...
            public CarStatusDataClass(CarStatusDataStruct statusStruct)
            {
                ...
                TyresWear = statusStruct.m_tyresWear.ToArray();
                ...
                TyresDamage = statusStruct.m_tyresDamage.ToArray();
                FrontLeftWingDamage = statusStruct.m_frontLeftWingDamage;
                FrontRightWingDamage = statusStruct.m_frontRightWingDamage;
                RearWingDamage = statusStruct.m_rearWingDamage;
                DrsFault = statusStruct.m_drsFault;
                EngineDamage = statusStruct.m_engineDamage;
                GearBoxDamage = statusStruct.m_gearBoxDamage;
